...
public class MenuLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login Employee");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(inputLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        // TODO add your handling code here:
        EmployeeBR empBR = new EmployeeBR();
        RegisterBook RB = new RegisterBook();
        String email = inputLogin.getText();
        String password = inputPassword.getText();
        boolean validation = empBR.validationLogin(email, password);
        if(validation){
            RB.executeRegisterBook();
        }else{
            System.exit(0);
        }
